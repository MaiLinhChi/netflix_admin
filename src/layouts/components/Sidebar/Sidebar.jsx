        ...
        <div className={clsx(style.sidebar)}>
            <div className={clsx(style['wrapper-list'])}>
                ...
                <ul className={clsx(style.list)}>
                    <NavLink to={config.routes.home} className={(nav) => clsx(style.item, { active: nav.isActive })}>
            ...
            <div className={clsx(style['wrapper-list'])}>
                ...
                <ul className={clsx(style.list)}>
                    <NavLink to={config.routes.users} className={(nav) => clsx(style.item, { active: nav.isActive })}>
                        <AiOutlineUser className={clsx(style.icon)} />
                        Users
                    </NavLink>
                    <NavLink to={config.routes.movies} className={(nav) => clsx(style.item, { active: nav.isActive })}>
                        <AiFillPlayCircle className={clsx(style.icon)} />
                        Movies
                    </NavLink>
                    <NavLink to={config.routes.lists} className={(nav) => clsx(style.item, { active: nav.isActive })}>
